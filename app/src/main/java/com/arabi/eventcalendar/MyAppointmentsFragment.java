...
public class MyAppointmentsFragment extends Fragment{
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        rvPendingWorks = (RecyclerView) view.findViewById(R.id.rv_pending_works);

        textView = (TextView) view.findViewById(R.id.textView);
        textView1 = (TextView) view.findViewById(R.id.textView1);

        rl = (RelativeLayout) view.findViewById(R.id.mainLayout);
            ...
            try {
                ...
                if (json.getString("status").equals("success")) {
                    ...
                    if(scheduleArray.length() != 0) {
                        ...
                        adapter = new AppointmentListAdapter(getActivity(), pendingJobItem);
